...
```
Without flex-wrap you get side scrolling and the four team memebers will overflow outside of their parent.  

With wrap you wrap the space around them. You limit the space they can take up.  

```css
  flex: 1 1 45%;
```
Shorthad for flex grow, flex shrink and flex basis.  

Flex basis is like the width of an element.  

"The width should be around 45% of the parent".  
...
```
There's not enough room due to the combination of padding and margin.  

Box-sizing: border-box can fix this issue.  
